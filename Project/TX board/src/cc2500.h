...
#define CC2500_SPI                       SPI5
#define CC2500_SPI_CLK                   RCC_APB2Periph_SPI5

#define CC2500_SPI_SCK_PIN               GPIO_Pin_7                  /* PE.02 */
#define CC2500_SPI_SCK_GPIO_PORT         GPIOF                       /* GPIOE */
#define CC2500_SPI_SCK_GPIO_CLK          RCC_AHB1Periph_GPIOF
#define CC2500_SPI_SCK_SOURCE            GPIO_PinSource7
#define CC2500_SPI_SCK_AF                GPIO_AF_SPI5

#define CC2500_SPI_MISO_PIN              GPIO_Pin_8                  /* PE.05 */
#define CC2500_SPI_MISO_GPIO_PORT        GPIOF                       /* GPIOE */
#define CC2500_SPI_MISO_GPIO_CLK         RCC_AHB1Periph_GPIOF
#define CC2500_SPI_MISO_SOURCE           GPIO_PinSource8
#define CC2500_SPI_MISO_AF               GPIO_AF_SPI5

#define CC2500_SPI_MOSI_PIN              GPIO_Pin_9                  /* PE.06 */
#define CC2500_SPI_MOSI_GPIO_PORT        GPIOF                       /* GPIOE */
#define CC2500_SPI_MOSI_GPIO_CLK         RCC_AHB1Periph_GPIOF
#define CC2500_SPI_MOSI_SOURCE           GPIO_PinSource9
#define CC2500_SPI_MOSI_AF               GPIO_AF_SPI5

#define CC2500_SPI_CS_PIN                GPIO_Pin_6                  /* PF.06 */
...
#define CC2500_VAL_CHANNR 	0x20	// 0x00 for TA beacon
