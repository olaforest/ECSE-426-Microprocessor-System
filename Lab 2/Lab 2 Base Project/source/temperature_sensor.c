...
void init(){
	// 50 Hz sampling
	SysTick_Config(10 * SystemCoreClock / 2000); 		// (1 / desired_frequency) * SystemCoreClock 
	
	// initialization and setup of the GPIO and ADC
	GPIO_init();
	ADC_init();
}
...
// Kalman filter to filter an input. Based on the Kalman filter that was used in Lab 1.
